        ...
        <div className='courses container'>
            <div className='courses-hero'>
                ...
                <div className='courses-hero-left'>
                    ...
                    <h2 class="subject-title">Trainings</h2>
                    <p>
                        In today's fast-paced work environment, stress and heavy workloads can easily lead to feelings of exhaustion, burnout, or even depression. For employees experiencing mental strain, our anonymous SOS consultation offers a confidential and effective way to address these challenges without the need to reveal personal information.
                    </p>

                </div>

                <div className='courses-hero-right'>
                    <img src={img_courses} alt='' className='courses-image' />

                    <div className='DotsWrapper'>
                        <svg xmlns="http://www.w3.org/2000/svg" width={186.223} height={249.21} viewBox="0 0 186.223 249.21" >
